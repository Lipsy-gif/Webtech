		   ...
		   <div> 
		     ...
		     <p> <h1 style="color: green">  X  <sub style="color:black"> Company </sub> <h1> </p>
		       ...
		       <h2 align= "right">
		        ...
		        Logged in as<a style ="color:SlateBlu;"  href= "http://localhost/Lab%20Task%204/Profile.php"> Lipsy | </a>
		  ...
		  <fieldset>
               ...
               <hr>
				...
				<div align="center">
		             ...
		             <h4 > <style="color: rgb(140, 140, 140);"> Copyright ©  <?php echo date(2021);?>  </h4>
